		...
		if (myPosition!=null){
			...
			if (!this.myMap.hasOpenNode()){
				...
				if (nextNodeId==null){
					...
					nextNodeId=this.myMap.getShortestPathToClosestOpenNode(myPosition.getLocationId(), list_agentNames).get(0);//getShortestPath(myPosition,this.openNodes.get(0)).get(0);
